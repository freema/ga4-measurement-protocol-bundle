...
use Freema\GA4MeasurementProtocolBundle\Dto\Parameter\AbstractParameter;
use Freema\GA4MeasurementProtocolBundle\Dto\Parameter\BaseParameter;
...
abstract class AbstractEvent implements ExportableInterface, ValidateInterface
{
     ...
     * @return string
     */
    protected function convertCamelCaseToSnakeCase(string $input): string
    {
     ...
     */
    public function setParamValue(string $paramName, $paramValue): self
    {
     ...
     */
    public function findOrCreateParameter(string $paramName): AbstractParameter
    {
     ...
     */
    public function findParameter(string $paramName): ?AbstractParameter
    {
     ...
     */
    public function addParam(string $parameterName, AbstractParameter $parameter): self
    {
     ...
     * @param string $paramName
     */
    public function deleteParameter(string $paramName): self
    {
        if (array_key_exists($paramName, $this->getParamList())) {
